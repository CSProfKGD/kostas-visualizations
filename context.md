...
- Parallel Stereo: use the user-supplied final raster `codex-clipboard-6cd16327-7a4a-4fb6-b16d-4bbf1aee67c0.png` for both dark and light teaser assets. It contains the conifer-and-rock scene, compact cameras, no projection rays, matching cyan epipolar lines, and corresponding red markers.
